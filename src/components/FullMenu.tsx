        ...
        <div className="grid gap-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="bg-white p-4 rounded shadow-md">
                <div className="flex justify-between items-center">
                  <h4 className="text-lg font-bold">Tortellini alla Panna</h4>
                  <span className="text-red-600 font-semibold">$17.00</span>
                </div>
                <p className="text-gray-600">
                  Cheese-filled tortellini with creamy sauce and ham.
                </p>
              </li>
              <li className="bg-white p-4 rounded shadow-md">
                <div className="flex justify-between items-center">
                  <h4 className="text-lg font-bold">Gnocchi alla Sorrentina</h4>
                  <span className="text-red-600 font-semibold">$16.00</span>
                </div>
                <p className="text-gray-600">
                  Potato gnocchi with tomato sauce and melted mozzarella.
                </p>
              </li>
              <li className="bg-white p-4 rounded shadow-md">
                <div className="flex justify-between items-center">
                  <h4 className="text-lg font-bold">Spaghetti Aglio e Olio</h4>
                  <span className="text-red-600 font-semibold">$13.00</span>
                </div>
                <p className="text-gray-600">
              ...
              <li className="bg-white p-4 rounded shadow-md">
                <div className="flex justify-between items-center">
                  <h4 className="text-lg font-bold">Pappardelle al Ragu</h4>
                  <span className="text-red-600 font-semibold">$19.00</span>
                </div>
                <p className="text-gray-600">
                  Wide ribbon pasta with slow-cooked meat ragu.
                </p>
              </li>
            </ul>
          </div>
